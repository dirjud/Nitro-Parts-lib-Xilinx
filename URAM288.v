...
`else
  ...
  assign CAS_IN_DIN_B_in[42] = (CAS_IN_DIN_B[42] !== 1'bx) && CAS_IN_DIN_B[42]; // rv 0
  assign CAS_IN_DIN_B_in[43] = (CAS_IN_DIN_B[43] !== 1'bx) && CAS_IN_DIN_B[43]; // rv 0
  assign CAS_IN_DIN_B_in[44] = (CAS_IN_DIN_B[44] !== 1'bx) && CAS_IN_DIN_B[44]; // rv 0
  assign CAS_IN_DIN_B_in[45] = (CAS_IN_DIN_B[45] !== 1'bx) && CAS_IN_DIN_B[45]; // rv 0
  assign CAS_IN_DIN_B_in[46] = (CAS_IN_DIN_B[46] !== 1'bx) && CAS_IN_DIN_B[46]; // rv 0
  assign CAS_IN_DIN_B_in[47] = (CAS_IN_DIN_B[47] !== 1'bx) && CAS_IN_DIN_B[47]; // rv 0
  assign CAS_IN_DIN_B_in[48] = (CAS_IN_DIN_B[48] !== 1'bx) && CAS_IN_DIN_B[48]; // rv 0
  assign CAS_IN_DIN_B_in[49] = (CAS_IN_DIN_B[49] !== 1'bx) && CAS_IN_DIN_B[49]; // rv 0
  assign CAS_IN_DIN_B_in[4] = (CAS_IN_DIN_B[4] !== 1'bx) && CAS_IN_DIN_B[4]; // rv 0
  assign CAS_IN_DIN_B_in[50] = (CAS_IN_DIN_B[50] !== 1'bx) && CAS_IN_DIN_B[50]; // rv 0
  assign CAS_IN_DIN_B_in[51] = (CAS_IN_DIN_B[51] !== 1'bx) && CAS_IN_DIN_B[51]; // rv 0
  assign CAS_IN_DIN_B_in[52] = (CAS_IN_DIN_B[52] !== 1'bx) && CAS_IN_DIN_B[52]; // rv 0
  assign CAS_IN_DIN_B_in[53] = (CAS_IN_DIN_B[53] !== 1'bx) && CAS_IN_DIN_B[53]; // rv 0
  assign CAS_IN_DIN_B_in[54] = (CAS_IN_DIN_B[54] !== 1'bx) && CAS_IN_DIN_B[54]; // rv 0
  assign CAS_IN_DIN_B_in[55] = (CAS_IN_DIN_B[55] !== 1'bx) && CAS_IN_DIN_B[55]; // rv 0
  assign CAS_IN_DIN_B_in[56] = (CAS_IN_DIN_B[56] !== 1'bx) && CAS_IN_DIN_B[56]; // rv 0
  assign CAS_IN_DIN_B_in[57] = (CAS_IN_DIN_B[57] !== 1'bx) && CAS_IN_DIN_B[57]; // rv 0
  assign CAS_IN_DIN_B_in[58] = (CAS_IN_DIN_B[58] !== 1'bx) && CAS_IN_DIN_B[58]; // rv 0
  assign CAS_IN_DIN_B_in[59] = (CAS_IN_DIN_B[59] !== 1'bx) && CAS_IN_DIN_B[59]; // rv 0
  assign CAS_IN_DIN_B_in[5] = (CAS_IN_DIN_B[5] !== 1'bx) && CAS_IN_DIN_B[5]; // rv 0
  assign CAS_IN_DIN_B_in[60] = (CAS_IN_DIN_B[60] !== 1'bx) && CAS_IN_DIN_B[60]; // rv 0
  assign CAS_IN_DIN_B_in[61] = (CAS_IN_DIN_B[61] !== 1'bx) && CAS_IN_DIN_B[61]; // rv 0
  assign CAS_IN_DIN_B_in[62] = (CAS_IN_DIN_B[62] !== 1'bx) && CAS_IN_DIN_B[62]; // rv 0
  assign CAS_IN_DIN_B_in[63] = (CAS_IN_DIN_B[63] !== 1'bx) && CAS_IN_DIN_B[63]; // rv 0
  assign CAS_IN_DIN_B_in[64] = (CAS_IN_DIN_B[64] !== 1'bx) && CAS_IN_DIN_B[64]; // rv 0
  assign CAS_IN_DIN_B_in[65] = (CAS_IN_DIN_B[65] !== 1'bx) && CAS_IN_DIN_B[65]; // rv 0
  assign CAS_IN_DIN_B_in[66] = (CAS_IN_DIN_B[66] !== 1'bx) && CAS_IN_DIN_B[66]; // rv 0
  assign CAS_IN_DIN_B_in[67] = (CAS_IN_DIN_B[67] !== 1'bx) && CAS_IN_DIN_B[67]; // rv 0
  assign CAS_IN_DIN_B_in[68] = (CAS_IN_DIN_B[68] !== 1'bx) && CAS_IN_DIN_B[68]; // rv 0
  assign CAS_IN_DIN_B_in[69] = (CAS_IN_DIN_B[69] !== 1'bx) && CAS_IN_DIN_B[69]; // rv 0
  assign CAS_IN_DIN_B_in[6] = (CAS_IN_DIN_B[6] !== 1'bx) && CAS_IN_DIN_B[6]; // rv 0
  assign CAS_IN_DIN_B_in[70] = (CAS_IN_DIN_B[70] !== 1'bx) && CAS_IN_DIN_B[70]; // rv 0
  assign CAS_IN_DIN_B_in[71] = (CAS_IN_DIN_B[71] !== 1'bx) && CAS_IN_DIN_B[71]; // rv 0
  assign CAS_IN_DIN_B_in[7] = (CAS_IN_DIN_B[7] !== 1'bx) && CAS_IN_DIN_B[7]; // rv 0
  assign CAS_IN_DIN_B_in[8] = (CAS_IN_DIN_B[8] !== 1'bx) && CAS_IN_DIN_B[8]; // rv 0
  assign CAS_IN_DIN_B_in[9] = (CAS_IN_DIN_B[9] !== 1'bx) && CAS_IN_DIN_B[9]; // rv 0
  assign CAS_IN_DOUT_A_in[0] = (CAS_IN_DOUT_A[0] !== 1'bx) && CAS_IN_DOUT_A[0]; // rv 0
  assign CAS_IN_DOUT_A_in[10] = (CAS_IN_DOUT_A[10] !== 1'bx) && CAS_IN_DOUT_A[10]; // rv 0
  assign CAS_IN_DOUT_A_in[11] = (CAS_IN_DOUT_A[11] !== 1'bx) && CAS_IN_DOUT_A[11]; // rv 0
  assign CAS_IN_DOUT_A_in[12] = (CAS_IN_DOUT_A[12] !== 1'bx) && CAS_IN_DOUT_A[12]; // rv 0
  assign CAS_IN_DOUT_A_in[13] = (CAS_IN_DOUT_A[13] !== 1'bx) && CAS_IN_DOUT_A[13]; // rv 0
  assign CAS_IN_DOUT_A_in[14] = (CAS_IN_DOUT_A[14] !== 1'bx) && CAS_IN_DOUT_A[14]; // rv 0
  assign CAS_IN_DOUT_A_in[15] = (CAS_IN_DOUT_A[15] !== 1'bx) && CAS_IN_DOUT_A[15]; // rv 0
  assign CAS_IN_DOUT_A_in[16] = (CAS_IN_DOUT_A[16] !== 1'bx) && CAS_IN_DOUT_A[16]; // rv 0
  assign CAS_IN_DOUT_A_in[17] = (CAS_IN_DOUT_A[17] !== 1'bx) && CAS_IN_DOUT_A[17]; // rv 0
  assign CAS_IN_DOUT_A_in[18] = (CAS_IN_DOUT_A[18] !== 1'bx) && CAS_IN_DOUT_A[18]; // rv 0
  assign CAS_IN_DOUT_A_in[19] = (CAS_IN_DOUT_A[19] !== 1'bx) && CAS_IN_DOUT_A[19]; // rv 0
  assign CAS_IN_DOUT_A_in[1] = (CAS_IN_DOUT_A[1] !== 1'bx) && CAS_IN_DOUT_A[1]; // rv 0
  assign CAS_IN_DOUT_A_in[20] = (CAS_IN_DOUT_A[20] !== 1'bx) && CAS_IN_DOUT_A[20]; // rv 0
  assign CAS_IN_DOUT_A_in[21] = (CAS_IN_DOUT_A[21] !== 1'bx) && CAS_IN_DOUT_A[21]; // rv 0
  assign CAS_IN_DOUT_A_in[22] = (CAS_IN_DOUT_A[22] !== 1'bx) && CAS_IN_DOUT_A[22]; // rv 0
  assign CAS_IN_DOUT_A_in[23] = (CAS_IN_DOUT_A[23] !== 1'bx) && CAS_IN_DOUT_A[23]; // rv 0
  assign CAS_IN_DOUT_A_in[24] = (CAS_IN_DOUT_A[24] !== 1'bx) && CAS_IN_DOUT_A[24]; // rv 0
  assign CAS_IN_DOUT_A_in[25] = (CAS_IN_DOUT_A[25] !== 1'bx) && CAS_IN_DOUT_A[25]; // rv 0
  assign CAS_IN_DOUT_A_in[26] = (CAS_IN_DOUT_A[26] !== 1'bx) && CAS_IN_DOUT_A[26]; // rv 0
  assign CAS_IN_DOUT_A_in[27] = (CAS_IN_DOUT_A[27] !== 1'bx) && CAS_IN_DOUT_A[27]; // rv 0
  assign CAS_IN_DOUT_A_in[28] = (CAS_IN_DOUT_A[28] !== 1'bx) && CAS_IN_DOUT_A[28]; // rv 0
  assign CAS_IN_DOUT_A_in[29] = (CAS_IN_DOUT_A[29] !== 1'bx) && CAS_IN_DOUT_A[29]; // rv 0
  assign CAS_IN_DOUT_A_in[2] = (CAS_IN_DOUT_A[2] !== 1'bx) && CAS_IN_DOUT_A[2]; // rv 0
  assign CAS_IN_DOUT_A_in[30] = (CAS_IN_DOUT_A[30] !== 1'bx) && CAS_IN_DOUT_A[30]; // rv 0
  assign CAS_IN_DOUT_A_in[31] = (CAS_IN_DOUT_A[31] !== 1'bx) && CAS_IN_DOUT_A[31]; // rv 0
  assign CAS_IN_DOUT_A_in[32] = (CAS_IN_DOUT_A[32] !== 1'bx) && CAS_IN_DOUT_A[32]; // rv 0
  assign CAS_IN_DOUT_A_in[33] = (CAS_IN_DOUT_A[33] !== 1'bx) && CAS_IN_DOUT_A[33]; // rv 0
  assign CAS_IN_DOUT_A_in[34] = (CAS_IN_DOUT_A[34] !== 1'bx) && CAS_IN_DOUT_A[34]; // rv 0
  assign CAS_IN_DOUT_A_in[35] = (CAS_IN_DOUT_A[35] !== 1'bx) && CAS_IN_DOUT_A[35]; // rv 0
  assign CAS_IN_DOUT_A_in[36] = (CAS_IN_DOUT_A[36] !== 1'bx) && CAS_IN_DOUT_A[36]; // rv 0
  assign CAS_IN_DOUT_A_in[37] = (CAS_IN_DOUT_A[37] !== 1'bx) && CAS_IN_DOUT_A[37]; // rv 0
  assign CAS_IN_DOUT_A_in[38] = (CAS_IN_DOUT_A[38] !== 1'bx) && CAS_IN_DOUT_A[38]; // rv 0
  assign CAS_IN_DOUT_A_in[39] = (CAS_IN_DOUT_A[39] !== 1'bx) && CAS_IN_DOUT_A[39]; // rv 0
  assign CAS_IN_DOUT_A_in[3] = (CAS_IN_DOUT_A[3] !== 1'bx) && CAS_IN_DOUT_A[3]; // rv 0
  assign CAS_IN_DOUT_A_in[40] = (CAS_IN_DOUT_A[40] !== 1'bx) && CAS_IN_DOUT_A[40]; // rv 0
  assign CAS_IN_DOUT_A_in[41] = (CAS_IN_DOUT_A[41] !== 1'bx) && CAS_IN_DOUT_A[41]; // rv 0
  assign CAS_IN_DOUT_A_in[42] = (CAS_IN_DOUT_A[42] !== 1'bx) && CAS_IN_DOUT_A[42]; // rv 0
  assign CAS_IN_DOUT_A_in[43] = (CAS_IN_DOUT_A[43] !== 1'bx) && CAS_IN_DOUT_A[43]; // rv 0
  assign CAS_IN_DOUT_A_in[44] = (CAS_IN_DOUT_A[44] !== 1'bx) && CAS_IN_DOUT_A[44]; // rv 0
  assign CAS_IN_DOUT_A_in[45] = (CAS_IN_DOUT_A[45] !== 1'bx) && CAS_IN_DOUT_A[45]; // rv 0
  assign CAS_IN_DOUT_A_in[46] = (CAS_IN_DOUT_A[46] !== 1'bx) && CAS_IN_DOUT_A[46]; // rv 0
  assign CAS_IN_DOUT_A_in[47] = (CAS_IN_DOUT_A[47] !== 1'bx) && CAS_IN_DOUT_A[47]; // rv 0
  assign CAS_IN_DOUT_A_in[48] = (CAS_IN_DOUT_A[48] !== 1'bx) && CAS_IN_DOUT_A[48]; // rv 0
  assign CAS_IN_DOUT_A_in[49] = (CAS_IN_DOUT_A[49] !== 1'bx) && CAS_IN_DOUT_A[49]; // rv 0
  assign CAS_IN_DOUT_A_in[4] = (CAS_IN_DOUT_A[4] !== 1'bx) && CAS_IN_DOUT_A[4]; // rv 0
  assign CAS_IN_DOUT_A_in[50] = (CAS_IN_DOUT_A[50] !== 1'bx) && CAS_IN_DOUT_A[50]; // rv 0
  assign CAS_IN_DOUT_A_in[51] = (CAS_IN_DOUT_A[51] !== 1'bx) && CAS_IN_DOUT_A[51]; // rv 0
  assign CAS_IN_DOUT_A_in[52] = (CAS_IN_DOUT_A[52] !== 1'bx) && CAS_IN_DOUT_A[52]; // rv 0
  assign CAS_IN_DOUT_A_in[53] = (CAS_IN_DOUT_A[53] !== 1'bx) && CAS_IN_DOUT_A[53]; // rv 0
  assign CAS_IN_DOUT_A_in[54] = (CAS_IN_DOUT_A[54] !== 1'bx) && CAS_IN_DOUT_A[54]; // rv 0
  assign CAS_IN_DOUT_A_in[55] = (CAS_IN_DOUT_A[55] !== 1'bx) && CAS_IN_DOUT_A[55]; // rv 0
  assign CAS_IN_DOUT_A_in[56] = (CAS_IN_DOUT_A[56] !== 1'bx) && CAS_IN_DOUT_A[56]; // rv 0
  assign CAS_IN_DOUT_A_in[57] = (CAS_IN_DOUT_A[57] !== 1'bx) && CAS_IN_DOUT_A[57]; // rv 0
  assign CAS_IN_DOUT_A_in[58] = (CAS_IN_DOUT_A[58] !== 1'bx) && CAS_IN_DOUT_A[58]; // rv 0
  assign CAS_IN_DOUT_A_in[59] = (CAS_IN_DOUT_A[59] !== 1'bx) && CAS_IN_DOUT_A[59]; // rv 0
  assign CAS_IN_DOUT_A_in[5] = (CAS_IN_DOUT_A[5] !== 1'bx) && CAS_IN_DOUT_A[5]; // rv 0
  assign CAS_IN_DOUT_A_in[60] = (CAS_IN_DOUT_A[60] !== 1'bx) && CAS_IN_DOUT_A[60]; // rv 0
  assign CAS_IN_DOUT_A_in[61] = (CAS_IN_DOUT_A[61] !== 1'bx) && CAS_IN_DOUT_A[61]; // rv 0
  assign CAS_IN_DOUT_A_in[62] = (CAS_IN_DOUT_A[62] !== 1'bx) && CAS_IN_DOUT_A[62]; // rv 0
  assign CAS_IN_DOUT_A_in[63] = (CAS_IN_DOUT_A[63] !== 1'bx) && CAS_IN_DOUT_A[63]; // rv 0
  assign CAS_IN_DOUT_A_in[64] = (CAS_IN_DOUT_A[64] !== 1'bx) && CAS_IN_DOUT_A[64]; // rv 0
  assign CAS_IN_DOUT_A_in[65] = (CAS_IN_DOUT_A[65] !== 1'bx) && CAS_IN_DOUT_A[65]; // rv 0
  assign CAS_IN_DOUT_A_in[66] = (CAS_IN_DOUT_A[66] !== 1'bx) && CAS_IN_DOUT_A[66]; // rv 0
  assign CAS_IN_DOUT_A_in[67] = (CAS_IN_DOUT_A[67] !== 1'bx) && CAS_IN_DOUT_A[67]; // rv 0
  assign CAS_IN_DOUT_A_in[68] = (CAS_IN_DOUT_A[68] !== 1'bx) && CAS_IN_DOUT_A[68]; // rv 0
  assign CAS_IN_DOUT_A_in[69] = (CAS_IN_DOUT_A[69] !== 1'bx) && CAS_IN_DOUT_A[69]; // rv 0
  assign CAS_IN_DOUT_A_in[6] = (CAS_IN_DOUT_A[6] !== 1'bx) && CAS_IN_DOUT_A[6]; // rv 0
  assign CAS_IN_DOUT_A_in[70] = (CAS_IN_DOUT_A[70] !== 1'bx) && CAS_IN_DOUT_A[70]; // rv 0
  assign CAS_IN_DOUT_A_in[71] = (CAS_IN_DOUT_A[71] !== 1'bx) && CAS_IN_DOUT_A[71]; // rv 0
  assign CAS_IN_DOUT_A_in[7] = (CAS_IN_DOUT_A[7] !== 1'bx) && CAS_IN_DOUT_A[7]; // rv 0
  assign CAS_IN_DOUT_A_in[8] = (CAS_IN_DOUT_A[8] !== 1'bx) && CAS_IN_DOUT_A[8]; // rv 0
  assign CAS_IN_DOUT_A_in[9] = (CAS_IN_DOUT_A[9] !== 1'bx) && CAS_IN_DOUT_A[9]; // rv 0
  assign CAS_IN_DOUT_B_in[0] = (CAS_IN_DOUT_B[0] !== 1'bx) && CAS_IN_DOUT_B[0]; // rv 0
  assign CAS_IN_DOUT_B_in[10] = (CAS_IN_DOUT_B[10] !== 1'bx) && CAS_IN_DOUT_B[10]; // rv 0
  assign CAS_IN_DOUT_B_in[11] = (CAS_IN_DOUT_B[11] !== 1'bx) && CAS_IN_DOUT_B[11]; // rv 0
  assign CAS_IN_DOUT_B_in[12] = (CAS_IN_DOUT_B[12] !== 1'bx) && CAS_IN_DOUT_B[12]; // rv 0
  assign CAS_IN_DOUT_B_in[13] = (CAS_IN_DOUT_B[13] !== 1'bx) && CAS_IN_DOUT_B[13]; // rv 0
  assign CAS_IN_DOUT_B_in[14] = (CAS_IN_DOUT_B[14] !== 1'bx) && CAS_IN_DOUT_B[14]; // rv 0
  assign CAS_IN_DOUT_B_in[15] = (CAS_IN_DOUT_B[15] !== 1'bx) && CAS_IN_DOUT_B[15]; // rv 0
  assign CAS_IN_DOUT_B_in[16] = (CAS_IN_DOUT_B[16] !== 1'bx) && CAS_IN_DOUT_B[16]; // rv 0
  assign CAS_IN_DOUT_B_in[17] = (CAS_IN_DOUT_B[17] !== 1'bx) && CAS_IN_DOUT_B[17]; // rv 0
  assign CAS_IN_DOUT_B_in[18] = (CAS_IN_DOUT_B[18] !== 1'bx) && CAS_IN_DOUT_B[18]; // rv 0
  assign CAS_IN_DOUT_B_in[19] = (CAS_IN_DOUT_B[19] !== 1'bx) && CAS_IN_DOUT_B[19]; // rv 0
  assign CAS_IN_DOUT_B_in[1] = (CAS_IN_DOUT_B[1] !== 1'bx) && CAS_IN_DOUT_B[1]; // rv 0
  assign CAS_IN_DOUT_B_in[20] = (CAS_IN_DOUT_B[20] !== 1'bx) && CAS_IN_DOUT_B[20]; // rv 0
  assign CAS_IN_DOUT_B_in[21] = (CAS_IN_DOUT_B[21] !== 1'bx) && CAS_IN_DOUT_B[21]; // rv 0
  assign CAS_IN_DOUT_B_in[22] = (CAS_IN_DOUT_B[22] !== 1'bx) && CAS_IN_DOUT_B[22]; // rv 0
  assign CAS_IN_DOUT_B_in[23] = (CAS_IN_DOUT_B[23] !== 1'bx) && CAS_IN_DOUT_B[23]; // rv 0
  assign CAS_IN_DOUT_B_in[24] = (CAS_IN_DOUT_B[24] !== 1'bx) && CAS_IN_DOUT_B[24]; // rv 0
  assign CAS_IN_DOUT_B_in[25] = (CAS_IN_DOUT_B[25] !== 1'bx) && CAS_IN_DOUT_B[25]; // rv 0
  assign CAS_IN_DOUT_B_in[26] = (CAS_IN_DOUT_B[26] !== 1'bx) && CAS_IN_DOUT_B[26]; // rv 0
  assign CAS_IN_DOUT_B_in[27] = (CAS_IN_DOUT_B[27] !== 1'bx) && CAS_IN_DOUT_B[27]; // rv 0
  assign CAS_IN_DOUT_B_in[28] = (CAS_IN_DOUT_B[28] !== 1'bx) && CAS_IN_DOUT_B[28]; // rv 0
  assign CAS_IN_DOUT_B_in[29] = (CAS_IN_DOUT_B[29] !== 1'bx) && CAS_IN_DOUT_B[29]; // rv 0
  assign CAS_IN_DOUT_B_in[2] = (CAS_IN_DOUT_B[2] !== 1'bx) && CAS_IN_DOUT_B[2]; // rv 0
  assign CAS_IN_DOUT_B_in[30] = (CAS_IN_DOUT_B[30] !== 1'bx) && CAS_IN_DOUT_B[30]; // rv 0
  assign CAS_IN_DOUT_B_in[31] = (CAS_IN_DOUT_B[31] !== 1'bx) && CAS_IN_DOUT_B[31]; // rv 0
  assign CAS_IN_DOUT_B_in[32] = (CAS_IN_DOUT_B[32] !== 1'bx) && CAS_IN_DOUT_B[32]; // rv 0
  assign CAS_IN_DOUT_B_in[33] = (CAS_IN_DOUT_B[33] !== 1'bx) && CAS_IN_DOUT_B[33]; // rv 0
  assign CAS_IN_DOUT_B_in[34] = (CAS_IN_DOUT_B[34] !== 1'bx) && CAS_IN_DOUT_B[34]; // rv 0
  assign CAS_IN_DOUT_B_in[35] = (CAS_IN_DOUT_B[35] !== 1'bx) && CAS_IN_DOUT_B[35]; // rv 0
  assign CAS_IN_DOUT_B_in[36] = (CAS_IN_DOUT_B[36] !== 1'bx) && CAS_IN_DOUT_B[36]; // rv 0
  assign CAS_IN_DOUT_B_in[37] = (CAS_IN_DOUT_B[37] !== 1'bx) && CAS_IN_DOUT_B[37]; // rv 0
  assign CAS_IN_DOUT_B_in[38] = (CAS_IN_DOUT_B[38] !== 1'bx) && CAS_IN_DOUT_B[38]; // rv 0
  assign CAS_IN_DOUT_B_in[39] = (CAS_IN_DOUT_B[39] !== 1'bx) && CAS_IN_DOUT_B[39]; // rv 0
  assign CAS_IN_DOUT_B_in[3] = (CAS_IN_DOUT_B[3] !== 1'bx) && CAS_IN_DOUT_B[3]; // rv 0
  assign CAS_IN_DOUT_B_in[40] = (CAS_IN_DOUT_B[40] !== 1'bx) && CAS_IN_DOUT_B[40]; // rv 0
  assign CAS_IN_DOUT_B_in[41] = (CAS_IN_DOUT_B[41] !== 1'bx) && CAS_IN_DOUT_B[41]; // rv 0
  assign CAS_IN_DOUT_B_in[42] = (CAS_IN_DOUT_B[42] !== 1'bx) && CAS_IN_DOUT_B[42]; // rv 0
  assign CAS_IN_DOUT_B_in[43] = (CAS_IN_DOUT_B[43] !== 1'bx) && CAS_IN_DOUT_B[43]; // rv 0
  assign CAS_IN_DOUT_B_in[44] = (CAS_IN_DOUT_B[44] !== 1'bx) && CAS_IN_DOUT_B[44]; // rv 0
  assign CAS_IN_DOUT_B_in[45] = (CAS_IN_DOUT_B[45] !== 1'bx) && CAS_IN_DOUT_B[45]; // rv 0
  assign CAS_IN_DOUT_B_in[46] = (CAS_IN_DOUT_B[46] !== 1'bx) && CAS_IN_DOUT_B[46]; // rv 0
  assign CAS_IN_DOUT_B_in[47] = (CAS_IN_DOUT_B[47] !== 1'bx) && CAS_IN_DOUT_B[47]; // rv 0
  assign CAS_IN_DOUT_B_in[48] = (CAS_IN_DOUT_B[48] !== 1'bx) && CAS_IN_DOUT_B[48]; // rv 0
  assign CAS_IN_DOUT_B_in[49] = (CAS_IN_DOUT_B[49] !== 1'bx) && CAS_IN_DOUT_B[49]; // rv 0
  assign CAS_IN_DOUT_B_in[4] = (CAS_IN_DOUT_B[4] !== 1'bx) && CAS_IN_DOUT_B[4]; // rv 0
  assign CAS_IN_DOUT_B_in[50] = (CAS_IN_DOUT_B[50] !== 1'bx) && CAS_IN_DOUT_B[50]; // rv 0
  assign CAS_IN_DOUT_B_in[51] = (CAS_IN_DOUT_B[51] !== 1'bx) && CAS_IN_DOUT_B[51]; // rv 0
  assign CAS_IN_DOUT_B_in[52] = (CAS_IN_DOUT_B[52] !== 1'bx) && CAS_IN_DOUT_B[52]; // rv 0
  assign CAS_IN_DOUT_B_in[53] = (CAS_IN_DOUT_B[53] !== 1'bx) && CAS_IN_DOUT_B[53]; // rv 0
  assign CAS_IN_DOUT_B_in[54] = (CAS_IN_DOUT_B[54] !== 1'bx) && CAS_IN_DOUT_B[54]; // rv 0
  assign CAS_IN_DOUT_B_in[55] = (CAS_IN_DOUT_B[55] !== 1'bx) && CAS_IN_DOUT_B[55]; // rv 0
  assign CAS_IN_DOUT_B_in[56] = (CAS_IN_DOUT_B[56] !== 1'bx) && CAS_IN_DOUT_B[56]; // rv 0
  assign CAS_IN_DOUT_B_in[57] = (CAS_IN_DOUT_B[57] !== 1'bx) && CAS_IN_DOUT_B[57]; // rv 0
  assign CAS_IN_DOUT_B_in[58] = (CAS_IN_DOUT_B[58] !== 1'bx) && CAS_IN_DOUT_B[58]; // rv 0
  assign CAS_IN_DOUT_B_in[59] = (CAS_IN_DOUT_B[59] !== 1'bx) && CAS_IN_DOUT_B[59]; // rv 0
  assign CAS_IN_DOUT_B_in[5] = (CAS_IN_DOUT_B[5] !== 1'bx) && CAS_IN_DOUT_B[5]; // rv 0
  assign CAS_IN_DOUT_B_in[60] = (CAS_IN_DOUT_B[60] !== 1'bx) && CAS_IN_DOUT_B[60]; // rv 0
  assign CAS_IN_DOUT_B_in[61] = (CAS_IN_DOUT_B[61] !== 1'bx) && CAS_IN_DOUT_B[61]; // rv 0
  assign CAS_IN_DOUT_B_in[62] = (CAS_IN_DOUT_B[62] !== 1'bx) && CAS_IN_DOUT_B[62]; // rv 0
  assign CAS_IN_DOUT_B_in[63] = (CAS_IN_DOUT_B[63] !== 1'bx) && CAS_IN_DOUT_B[63]; // rv 0
  assign CAS_IN_DOUT_B_in[64] = (CAS_IN_DOUT_B[64] !== 1'bx) && CAS_IN_DOUT_B[64]; // rv 0
  assign CAS_IN_DOUT_B_in[65] = (CAS_IN_DOUT_B[65] !== 1'bx) && CAS_IN_DOUT_B[65]; // rv 0
  assign CAS_IN_DOUT_B_in[66] = (CAS_IN_DOUT_B[66] !== 1'bx) && CAS_IN_DOUT_B[66]; // rv 0
  assign CAS_IN_DOUT_B_in[67] = (CAS_IN_DOUT_B[67] !== 1'bx) && CAS_IN_DOUT_B[67]; // rv 0
  assign CAS_IN_DOUT_B_in[68] = (CAS_IN_DOUT_B[68] !== 1'bx) && CAS_IN_DOUT_B[68]; // rv 0
  assign CAS_IN_DOUT_B_in[69] = (CAS_IN_DOUT_B[69] !== 1'bx) && CAS_IN_DOUT_B[69]; // rv 0
  assign CAS_IN_DOUT_B_in[6] = (CAS_IN_DOUT_B[6] !== 1'bx) && CAS_IN_DOUT_B[6]; // rv 0
  assign CAS_IN_DOUT_B_in[70] = (CAS_IN_DOUT_B[70] !== 1'bx) && CAS_IN_DOUT_B[70]; // rv 0
  assign CAS_IN_DOUT_B_in[71] = (CAS_IN_DOUT_B[71] !== 1'bx) && CAS_IN_DOUT_B[71]; // rv 0
  assign CAS_IN_DOUT_B_in[7] = (CAS_IN_DOUT_B[7] !== 1'bx) && CAS_IN_DOUT_B[7]; // rv 0
  assign CAS_IN_DOUT_B_in[8] = (CAS_IN_DOUT_B[8] !== 1'bx) && CAS_IN_DOUT_B[8]; // rv 0
  assign CAS_IN_DOUT_B_in[9] = (CAS_IN_DOUT_B[9] !== 1'bx) && CAS_IN_DOUT_B[9]; // rv 0
  assign CAS_IN_EN_A_in = (CAS_IN_EN_A !== 1'bx) && CAS_IN_EN_A; // rv 0
  assign CAS_IN_EN_B_in = (CAS_IN_EN_B !== 1'bx) && CAS_IN_EN_B; // rv 0
  assign CAS_IN_RDACCESS_A_in = (CAS_IN_RDACCESS_A !== 1'bx) && CAS_IN_RDACCESS_A; // rv 0
  assign CAS_IN_RDACCESS_B_in = (CAS_IN_RDACCESS_B !== 1'bx) && CAS_IN_RDACCESS_B; // rv 0
  assign CAS_IN_RDB_WR_A_in = (CAS_IN_RDB_WR_A !== 1'bx) && CAS_IN_RDB_WR_A; // rv 0
  assign CAS_IN_RDB_WR_B_in = (CAS_IN_RDB_WR_B !== 1'bx) && CAS_IN_RDB_WR_B; // rv 0
  assign CAS_IN_SBITERR_A_in = (CAS_IN_SBITERR_A !== 1'bx) && CAS_IN_SBITERR_A; // rv 0
  assign CAS_IN_SBITERR_B_in = (CAS_IN_SBITERR_B !== 1'bx) && CAS_IN_SBITERR_B; // rv 0
  assign CLK_in = (CLK !== 1'bx) && (CLK ^ IS_CLK_INVERTED_REG); // rv 0
  assign DIN_A_in = DIN_A;
  assign DIN_B_in = DIN_B;
  assign EN_A_in = (EN_A !== 1'bx) && (EN_A ^ IS_EN_A_INVERTED_REG); // rv 0
  assign EN_B_in = (EN_B !== 1'bx) && (EN_B ^ IS_EN_B_INVERTED_REG); // rv 0
  assign INJECT_DBITERR_A_in = (INJECT_DBITERR_A !== 1'bx) && INJECT_DBITERR_A; // rv 0
  assign INJECT_DBITERR_B_in = (INJECT_DBITERR_B !== 1'bx) && INJECT_DBITERR_B; // rv 0
  assign INJECT_SBITERR_A_in = (INJECT_SBITERR_A !== 1'bx) && INJECT_SBITERR_A; // rv 0
  assign INJECT_SBITERR_B_in = (INJECT_SBITERR_B !== 1'bx) && INJECT_SBITERR_B; // rv 0
  assign OREG_CE_A_in = (OREG_CE_A === 1'bx) || OREG_CE_A; // rv 1
  assign OREG_CE_B_in = (OREG_CE_B === 1'bx) || OREG_CE_B; // rv 1
  assign OREG_ECC_CE_A_in = (OREG_ECC_CE_A === 1'bx) || OREG_ECC_CE_A; // rv 1
  assign OREG_ECC_CE_B_in = (OREG_ECC_CE_B === 1'bx) || OREG_ECC_CE_B; // rv 1
  assign RDB_WR_A_in = (RDB_WR_A !== 1'bx) && (RDB_WR_A ^ IS_RDB_WR_A_INVERTED_REG); // rv 0
  assign RDB_WR_B_in = (RDB_WR_B !== 1'bx) && (RDB_WR_B ^ IS_RDB_WR_B_INVERTED_REG); // rv 0
  assign RST_A_in = (RST_A !== 1'bx) && (RST_A ^ IS_RST_A_INVERTED_REG); // rv 0
  assign RST_B_in = (RST_B !== 1'bx) && (RST_B ^ IS_RST_B_INVERTED_REG); // rv 0
  assign SLEEP_in = (SLEEP !== 1'bx) && SLEEP; // rv 0
`endif 
...
begin
  ...
  if (CAS_IN_DBITERR_A === 1'bx) begin
    cas_a_warning = 1'b1;
  ...
  if (CAS_IN_RDACCESS_A === 1'bx) begin
    cas_a_warning = 1'b1;
  ...
  if (CAS_IN_SBITERR_A === 1'bx) begin
    cas_a_warning = 1'b1;
